...
<<<<<<< HEAD
      ...
      // console.log("hasSecondary :: " + self.s.replicaSetState.hasSecondary())
      // If we have a primary and a disconnect handler, execute
      // buffered operations
      if(self.s.replicaSetState.hasPrimaryAndSecondary() && self.s.disconnectHandler) {
        self.s.disconnectHandler.execute();
...
<<<<<<< HEAD
  // console.log("  ==== ping server :: " + server.name)
=======
>>>>>>> 9085901e776eff8a7d8a529a69717fc636b6145b
  // Execute ismaster
...
<<<<<<< HEAD
    // console.log("  ==== ping server result :: " + server.name)
    // console.dir(err)
    // console.log("hasPrimary :: " + self.s.replicaSetState.hasPrimary())
    // console.log("hasPrimaryAndSecondary :: " + self.s.replicaSetState.hasPrimaryAndSecondary())
    // console.log("hasSecondary :: " + self.s.replicaSetState.hasSecondary())
    // console.log("connectingServers :: ")
    // console.log(self.s.connectingServers)
    // console.log(self.s.replicaSetState.unknownServers)
...
<<<<<<< HEAD
  ...
  // console.dir(options)
  // console.dir(servers)
  // console.dir(self.s.replicaSetState.allServers())
...
<<<<<<< HEAD
            // console.log("!!!!!!!!!!!!! setTimeout :: " + self.state)
            // console.log("hasPrimary :: " + self.s.replicaSetState.hasPrimary())
            // console.log("hasPrimaryAndSecondary :: " + self.s.replicaSetState.hasPrimaryAndSecondary())
            // console.log("hasSecondary :: " + self.s.replicaSetState.hasSecondary())
...
<<<<<<< HEAD
              // if(self.s.replicaSetState.hasPrimaryAndSecondary()) {
              //   process.nextTick(function() {
            ...
            // } else if(_self.state == CONNECTING && _options.haInterval && count == 0) {
            //   self.emit('error', new MongoError('no primary found in replicaset'));
            //   clearInterval(intervalId);
            //   return self.destroy();
            }
          } else {
            // console.log("!!!!!!!!!!!!! setInterval :: " + self.state)
            // console.log("hasPrimary :: " + self.s.replicaSetState.hasPrimary())
            // console.log("hasPrimaryAndSecondary :: " + self.s.replicaSetState.hasPrimaryAndSecondary())
            // console.log("hasSecondary :: " + self.s.replicaSetState.hasSecondary())
...
<<<<<<< HEAD
  ...
  // var hosts = self.s.connectingServers.map(function(x) {
  //   return x.name;
  // });
...
<<<<<<< HEAD
    // return connectNewServers(self, hosts, function() {});
=======
>>>>>>> 9085901e776eff8a7d8a529a69717fc636b6145b
  } else {
    for(var i = 0; i < servers.length; i++) {
...
>>>>>>> 9085901e776eff8a7d8a529a69717fc636b6145b
      ...
      connectNewServers(self, self.s.replicaSetState.unknownServers, function() {
<<<<<<< HEAD
        // console.log("=============== attempt reconnect to disconnected servers 1 :: " + self.s.replicaSetState.hasPrimary() + " :: " + new Date())
...
<<<<<<< HEAD
  ...
  // // Run a reconnection interval
  // var reconnectIntervalId = setInterval(function() {
  //   if(self.state === DESTROYED) {
  //     return clearInterval(reconnectIntervalId)
  //   }
  //
  //   // console.log("=============== attempt reconnect to disconnected servers 0")
  //   // console.log(self.s.replicaSetState.unknownServers.length)
  //   // console.log(hosts.length)
  //   connectNewServers(self, self.s.replicaSetState.unknownServers, function() {
  //   // connectNewServers(self, hosts, function() {
  //     console.log("=============== attempt reconnect to disconnected servers 1 :: " + new Date())
  //   });
  // }, _haInterval);
}
...
//           if(self.s.connectingServers.indexOf(_server.name) == -1) {
//             self.s.connectingServers.push(_server.name);
//           }
//           // Remove server from the state
...
//     console.log(self.s.replicaSetState.allServers().map(x => {
//       return x.name
//     }))
//     // console.log(self.s.replicaSetState.unknownServers.map(x => {
//     //   return x.name
//     // }))
//     console.log(self.s.connectingServers)
//
...
//       console.log("===== start ping :: " + connectingServers[i])
//       pingServer(self, connectingServers[i], function(e, r) {
//         console.log("===== end ping :: " + count)
//         if(r)console.dir(r.result.me)
//         count = count - 1;
//
//         if(count == 0) {
...
<<<<<<< HEAD
      // // Add to connecting list
      // if(self.s.connectingServers.indexOf(this.name) == -1) {
      //   // console.log("!!!!!!!!!! pushing connectingServers 0")
      //   self.s.connectingServers.push(this.name);
      // }
=======
>>>>>>> 9085901e776eff8a7d8a529a69717fc636b6145b
...
<<<<<<< HEAD
    ...
    // console.log(self.s.connectingServers.map(x => x.name))

    if(self.initialConnectState.connect
      && !self.initialConnectState.fullsetup
      && self.s.replicaSetState.hasPrimaryAndSecondary()) {
        // console.log("========= emit fullsetup 0")
=======
    if(self.initialConnectState.connect
      && !self.initialConnectState.fullsetup
      && self.s.replicaSetState.hasPrimaryAndSecondary()) {
...
<<<<<<< HEAD
  // console.log("!!!!!!!!!! pushing connectingServers 2")
=======
>>>>>>> 9085901e776eff8a7d8a529a69717fc636b6145b
